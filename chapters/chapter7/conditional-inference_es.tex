...
\begin{example}[Completación de imágenes y predicción de texto]
    ...
    GPT) y el completamiento de imágenes (como el autoencoder enmascarado), que
...
y los resultados del autoencoder enmascarado para el completamiento de imágenes naturales
