...
Se trata de {\em ¿cómo aprender de manera efectiva y eficiente una
    distribución de datos de dimensionalidad baja en un espacio de dimensionalidad alta y
    luego transformar est distribución en una representación compacta y 
...
Este libro de texto intenta proveer una introduccón sistematica a los
...
de posgrado que están comenzando sus estudios}. Los principales
...
entusiasmo como de los temores en el seno de la sociedad. Creemos es más urgente
...
libro como un primer intento de desarfrollar {\em una teoría matemática de la 
...
modelos analíticaos geométricos, algebráicos y probabilísticos 
...
representar estructuras {\em de baja dimensionalidad} en la
...
de baja dimensionalidad. Desde esta perspectiva, incluso muchas
...
\begin{enumerate}
    ...
    \item La inferencia bayesiana por vía del máximo a posteriori o
        ...
        restricciones por vía de técnicas de continuación
...
\begin{enumerate}
    \item Comenzaremos con los modelos clásicos y más básicos del
        ...
        de baja dimensionalidad que interesan poseen estructuras
    ...
    \item A fin de generalizar estos modelos clásicos y extender
        sus soluciones a distribuciones de baja dimensionalidad que no
        puedan ser representadas fácilmente por algún modelo analítco
        ...
        coincidencia de puntajes, compresión con pérdidas y distorsión de
    ...
    \item En este marco unificador, las redes neuronales profundas (DNNs),
        ...
        (desplegados) que iterativamente logran mejor compresión
    ...
    \item Por último, pero no menos importante, traremos paso a paso como 
        aprender de manera efectiva y eficiente las representaciones profundas
        de distribuciones de baja dimensionalidad a partir de grandes conjuntos
...
datos, entre unos modelos paramétricos simplpes y los modelos
...
\begin{quote}
    ...
    de baja dimensionalidad de distribuciones de datos embebidas
