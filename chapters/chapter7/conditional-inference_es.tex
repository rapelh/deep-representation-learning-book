...
\begin{example}[Completación de imágenes y predicción de texto]
    ...
    GPT) y la completación de imágenes (como el autoencoder enmascarado), que
...
\subsection{Completación de imágenes mediante auto-codificación enmascarada}
...
del autoencoder enmascarado así diseñado. Para obtener más detalles sobre la implementación 
y los resultados del autoencoder enmascarado para la completación de imágenes naturales
...
\textcite{rout2023solving} (que utilizan modelos de difusión latente, tal como los hemos
    desarrollado para los autoencoders de representación en el
...
\textcite{song2022solving} y la verdad de referencia (ground truth). Se puede observar que el método basado en la difusión
...
de autoencoders variacionales especializados y preentrenados $f : \bR^{D_{\mathrm{img}}} \to
...
lograr mediante una incrustción conjunta,
