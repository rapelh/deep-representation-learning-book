...
\begin{equation}
    d(\X, \hat \X).
\end{equation}
Esto nos lleva al concepto de {\em representación auto-consistente}. Como
ya mencionamos brevemente en el
\Cref{ch:intro} (véase la \Cref{fig:autoencoder}), la {\em auto-codificación}
---que integra los
...
\end{equation}
Observe que el error de cuantización $\epsilon$ actúa como parámetro de trade-off
...
\begin{figure}
    ...
    \caption{Ilustración de un aut-codificador típico, como el PCA, que busca
