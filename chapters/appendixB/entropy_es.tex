...
direcciones principales. Cuando las dimensiones de los componentes $d_k$ son grandes, este
...
\begin{proof}[(Demostración de \Cref{lem:rate-distortion-lb-uos})]
    ...
    uniforme.
    Dado que el supuesto sobre $\delta$ implica que los componentes de la mezcla en
