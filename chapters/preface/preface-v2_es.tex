...
% \begin{center}
%     «{\em Todos los caminos llevan a Roma}».

% \end{center}
% \vspace{5mm}

Como libro de código abierto, la primera versión, titulada «{\em Aprendizaje de representaciones 
profundas de distribuciones de datos}», lanzada el 18 de agosto de 2025, se ha actualizado de manera frecuente y constante en los últimos seis meses. 
Al mismo tiempo, basados en nuestra experiencia usando el libro en un nuevo curso impartido 
en la Universidad de Hong Kong en el semestre de otoño de 2025, así como en los comentarios que hemos 
recibido de colegas, tutores y estudiantes, hemos identificado numerosos puntos a lo largo 
del libro que merecen una mayor revisión y ampliación.
...
solución oportuna para esta situación.
...
\begin{itemize}
    ...
    \item En el Capítulo \ref{ch:deep-networks} actualizado sobre el diseño
        ...
        de transformador transparente (white-box) CRATE, que resulta importante para el
    ...
    \item En el Capítulo \ref{ch:consistent-representations} actualizado 
        ...
        y prácticos basados en auto-codificación, como la auto-codificación
        variacional o los auto-codificadores de representaciones. 
    \item En el Capítulo \ref{ch:conditional-inference} actualizado hemos
        ...
        condicionada a través de la perspectiva de la información mutua. Proporciona
    ...
    \item El Capítulo \ref{ch:applications} ampliado sobre aplicaciones ahora
        ...
        distribuciones y de representaciones de datos reales,
        incluyendo imágenes bidimensionales, objetos naturales tridimensionales, 
    ...
    \item El Capítulo \ref{ch:future} final, sobre líneas de 
        ...
        estudiarse cualitativa y cuantitativamente con medios
...
Stephen Butterfill y Jeroen Van Goey por haber contribuido correcciones y ajustes al manuscrito.
