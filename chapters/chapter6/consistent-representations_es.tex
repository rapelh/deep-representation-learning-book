...
representación discriminativa lin-
eal
...
Obsérvese que, con el autoencodificador aprendido
...
Results are shown in la \Cref{fig:justify_xhat_equals_x_incremental},
where we observe that the reconstructed $\hat{\X}$ preserves the main
visual characteristics of $\X$ including shapes and textures. En el caso de un
...
muestras individuales, como lo hacen la mayoría de los métodos de autoencodificación, y (2) después de
...
autoencodificación consistente a nivel de muestra, necesitamos lograr que $\hat \x$
...
respectivamente. Demontran que el marco de bucle cerrado
...
\paragraph{Redes neuronales superficiales vs. profundas, para la autoencodificación y otras aplicaciones.}
