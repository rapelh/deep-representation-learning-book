...
de rango bajo} es un problema clásico de completación de datos cuando
...
\begin{figure}[t]
    ...
    \caption{\small \textbf{Visualizaciones de autoencodificación de CRATE-Base
...
\begin{example}\label{example:denoising-conditional-gaussian}
    ...
    $\sigma^2$.
    Podemos comprender mejor su comportamiento comparándolo con
    ...
    \eqref{eq:conditional-posterior-denoiser-gaussian-case}: según
