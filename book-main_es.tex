\newenvironment{nohyphens}
  {\par
   ...
   \sloppy} % Allows wider spaces to prevent overfull boxes
  {\par}
...
\usepackage{fancyhdr}
\addto\captionsenglish{\renewcommand{\bibname}{Bibliografía}}
...
\newcommand{\crefmiddlegroupconjunction}{ y }
\newcommand{\creflastgroupconjunction}{ y }
...
\makeatletter
\addto\captionsenglish{\renewcommand{\ALG@name}{Algoritmo}}
\DeclareCaptionLabelFormat{alglabel}{\bfseries\csname ALG@name\endcsname~#2:}
...
\@ifclassloaded{EngC}{}{
    ...
    \renewcommand{\maketitlehookd}{%
        \vspace{6em}\footnotesize $^*$\,Estos autores contribuyeron por igual.
    }
}
\makeatother
...
\patchcmd{\definition}{Definition}{Definición}{}{}
\patchcmd{\chapter}{Chapter}{Capítulo}{}{}
\patchcmd{\assumption}{Assumption}{Supuesto}{}{}
\patchcmd{\lemma}{Lemma}{Lema}{}{}
\patchcmd{\theorem}{Theorem}{Teorema}{}{}
\patchcmd{\corollary}{Corollary}{Corolario}{}{}
\patchcmd{\example}{Example}{Ejemplo}{}{}
\patchcmd{\remark}{Remark}{Nota}{}{}
\patchcmd{\exercise}{Exercise}{Ejercicio}{}{}
\patchcmd{\proposition}{Proposition}{Proposición}{}{}
\patchcmd{\proof}{Proof}{Demostración}{}{}
...
\@ifclassloaded{EngC}{
    ...
    \author{
        ...
        y la inteligencia en general, que será impartido por los autores en
        sus respectivas
        instituciones. Esta versión previa a la publicación está disponible gratuitamente 
        ver y descargar únicamente para
        uso personal y no se permite su redistribución, su reventa ni su
        uso en obras
