...
los conceptos básicos del procesamiento de señales (representaciones esparsas y sensores
...
avances extraordinarios en estos últimos años, tanto por los autores como por
...
posible estudiar la inteligencia como una disciplina científica y matemática. Argumentaremos
...
\begin{enumerate}
    ...
    \item La eliminación de ruido y la reducción de dimensionalidad
        en el procesamiento clásico de señales frente a los modelos
        de difusión y eliminación de ruido de los métodos generativos
        modernos;
    \item La inferencia bayesiana por vía del máximo a posteriori o
        del muestreo condicionado frente a la optimización con 
...
\begin{enumerate}
    \item Comenzaremos con los modelos clásicos y más básicos del
        ...
        como a eliminación de ruidos y la reducción de dimensionalidad} sobre
    ...
    \item Para generalizar estos modelos clásicos y extender
        ...
        incluyendo la minimización de entropía, la eliminación de ruido mediante
        score-matching, compresión con pérdidas y distorsión de 
        tasa, así como el aprendizaje discriminativo de representaciones
        mediante maximización de la ganancia de información.

    \item En este marco unificador, las redes neuronales profundas (DNNs) modernas,
        como ResNet, CNN y Transformer, pueden todas 
        interpretarse matemáticamente (desenrollarse) como algoritmos de optimización
        que iterativamente logran mejor compresión
        y mejor representación al reducir la longitud o la tasa de 
        codificación o al ganar información. Este marco no solo ayuda
        a explicar las arquitecturas de redes profundas diseñadas empíricamente
        hasta ahora, sino que también conduce a nuevos
        diseños arquitectónicos que pueden ser significativamente 
        más simples y eficientes.

    \item Más allá de lo anterior, para que la representación
        ...
        que incluyen tanto codificación como decodificación. Para que
        ...
        en circuito cerrado} que permite que un sistema autocodificador se
        autocorrija y, por tanto, se autoperfeccione, por medio
        de un juego minimax entre codificador y decodificador.

    \item Para conectar la teoría con la práctica, entonces estudiaremos cómo
        ...
        estimación, el completamiento y la generación condicionados de datos
    ...
    \item Por último, pero no menos importante, mostraremos paso a paso cómo 
        ...
        corporales y datos textuales. Estos se usarán en numerosas aplicaciones
...
y un marco deductivo unificado basado en principios fundamentales.
...
la formulación teórica a la deducción matemática, seguida de la 
