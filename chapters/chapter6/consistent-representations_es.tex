...
extender el autoencoder a clases más generales de distribuciones cuyos
...
donde el marco del «autoencoder de representaciones» muestra cómo las representaciones aprendidas en bucle abierto
...
\begin{figure}
    ...
    \caption{Ilustración de un autoencoder típico, como el PCA, que busca
...
es posible aprender autoencoders consistentes mediante este marco---puesto que, para
cualquier muestra aleatoria de datos, siempre que se disponga de suficientes parámetros, existen tales pares de autoencoders---
...
los autoencoders más profundos a los menos profundos.
...
El autoencoder disperso está diseñado para resolver algunas de estas limitaciones. En
...
\begin{figure}
    ...
    \caption{Ilustración de un autoencoder disperso (SAE), en comparación con
    la de un autoencoder típico (AE) en la \Cref{fig:AE}. }
    \label{fig:SAE}
\end{figure}
...
corresponden al \textit{decodificador} del autoencoder.
...
\begin{figure}[t]
    ...
    \caption{Diagrama del modelo de difusión latente tomado del trabajo de
        \cite{rombach2022high}, que utiliza un autoencoder variacional
...
como los autoencoders de representación (RAE), que se
...
Los enfoques anteriores para entrenar pares de autoencoders con el fin de aprender representaciones
...
la dispersión en el autoencoder disperso o la gaussianidad en el VAE).
...
Por lo tanto, en definitiva, queremos entrenar un autoencoder para los datos $\X$
...
autoencoder, que es lo que hemos estudiado en profundidad anteriormente en este capítulo.
...
Obsérvese que, con el autoencoder aprendido
...
La mayoría de los métodos generativos basados en memoria utilizan autoencoders, VAE o
...
\cite{van-den-Oord2017-jr}, que se fundamenta en la metodología de los autoencoders variacionales
