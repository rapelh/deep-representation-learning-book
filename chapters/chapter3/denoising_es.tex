...
\section{Compresión mediante reducción de ruido}
\label{sub:compression_denoising}
...
\subsection{Procesos de difusión y de reducción de ruido}
...
\begin{figure}
    ...
    \caption{\small \textbf{Filtro de eliminación de ruido óptimo de Bayes y puntuación de un
        modelo de mezcla gaussiana.} En el mismo contexto que
